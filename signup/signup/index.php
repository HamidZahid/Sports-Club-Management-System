...
include("config.php");
$result = mysqli_query($conn, "SELECT* from bilal ORDER by id DESC");
?>
...
<body>
        ...
        <div class="card-body">
          <form action="" method="POST">
            ...
            <div>
              ...
              <button class="btn btn--radius-2 btn--red" type="submit" name="submit">
                Register
              </button>
  ...
  if (isset($_POST['submit'])) {
    ...
    $result = mysqli_query($conn, "INSERT into bilal value('', '$first_name', '$last_name', '$company', '$email','$area_code','$phone','$subject','$exist')");
    // if ($result) {
